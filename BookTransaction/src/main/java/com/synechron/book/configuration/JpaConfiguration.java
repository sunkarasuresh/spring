package com.synechron.book.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.synechron.book.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.synechron.book.model" });
